...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
   ...
   config.vm.define "elkdata1" do |elkdata1|
	...
	elkdata1.vm.network "public_network", ip: "10.0.3.103", :bridge => "lxcbr0"
	elkdata1.vm.network "private_network", type: "dhcp"
	elkdata1.vm.network "forwarded_port", guest: 5601, host: 35601
...
#   end
   ...
   config.vm.define "elkdata2" do |elkdata2|
	...
	elkdata2.vm.network "public_network", ip: "10.0.3.104", :bridge => "lxcbr0"
...
#	logstash1.vm.network "public_network", ip: "10.0.3.111", :bridge => "lxcbr0"
